...
{
    /**
     * URL folder Google Drive sumber materi.
     */
    private $materialsUrl = 'https://drive.google.com/drive/folders/1UBg9EhU_bgo2THztAnYfTby5IC2FmpUG?usp=sharing';
    ...
    private $documents = [
        ...
        'kartu-pp' => [
            ...
            'drive_id'    => '1Yk33NUBRP3BES2p9aJ73iK7Zlux8jsvL',
            'icon'        => 'fa-id-card',
        ],
        ...
        'kartu-pk' => [
            ...
            'drive_id'    => '1CnCAkZo5W0E4MEb98bXDAfPZSGPB7kTy',
            'icon'        => 'fa-id-card',
        ],
        ...
        'surat-undangan' => [
            ...
            'drive_id'    => '1ycXim-gUTvdF_7GzWMJaivYkKcsPf_-T',
            'icon'        => 'fa-envelope',
        ],
    ];
    ...
    /**
     * Membersihkan cache dokumen.
     *
     * Digunakan apabila daftar dokumen mengalami perubahan.
     */
    public function clearCache()
    {
        ...
        if (request()->expectsJson()) {
            return response()->json([
                'message' => 'Cache dokumen berhasil dibersihkan.',
            ]);
        }

        return redirect()
            ->back()
            ->with('success', 'Cache dokumen berhasil dibersihkan.');
    }
}