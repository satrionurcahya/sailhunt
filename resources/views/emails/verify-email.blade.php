...
<body>
    <div class="container">
        ...
        <div class="body">
            ...
            <p>
                Terima kasih telah mendaftarkan unit PMR Anda di
                <strong>Sail & Hunt Chapter I</strong>.
            </p>

            <p>
                Untuk mengaktifkan akun dan dapat mengikuti seluruh rangkaian kompetisi,
                Anda perlu melakukan verifikasi email terlebih dahulu.
            </p>

            <div class="warning">
                <strong>⏳ Link ini berlaku selama 60 menit.</strong>
                Jika sudah melewati batas waktu, silakan daftar ulang atau hubungi admin.
            </div>
            ...
            <p style="font-size: 14px; color: #94a3b8;">
                ...
                <br>
                <a href="{{ $verificationUrl }}" style="word-break: break-all; color: #1872B5;">
                    {{ $verificationUrl }}
                </a>
            </p>
